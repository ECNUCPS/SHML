...
public class ShmlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ShmlPackage.SYSTEM: {
				ecnu.models.xshml.xshml.shml.System system = (ecnu.models.xshml.xshml.shml.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseSystem(ecnu.models.xshml.xshml.shml.System object) {
		return null;
	}
