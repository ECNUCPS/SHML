 ...
 * </p>
 * <ul>
 *   <li>{@link ecnu.models.xshml.xshml.shml.impl.IntervalImpl#getName <em>Name</em>}</li>
 *   <li>{@link ecnu.models.xshml.xshml.shml.impl.IntervalImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link ecnu.models.xshml.xshml.shml.impl.IntervalImpl#getRight <em>Right</em>}</li>
 *   <li>{@link ecnu.models.xshml.xshml.shml.impl.IntervalImpl#getSubinterval <em>Subinterval</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntervalImpl extends EObjectImpl implements Interval {
	...
	protected EClass eStaticClass() {
		return ShmlPackage.Literals.INTERVAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShmlPackage.INTERVAL__NAME, oldName, name));
	}
	...
	public void setLeft(float newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShmlPackage.INTERVAL__LEFT, oldLeft, left));
	}
	...
	public void setRight(float newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShmlPackage.INTERVAL__RIGHT, oldRight, right));
	}
	...
	public void setSubinterval(float newSubinterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShmlPackage.INTERVAL__SUBINTERVAL, oldSubinterval, subinterval));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ShmlPackage.INTERVAL__NAME:
				return getName();
			case ShmlPackage.INTERVAL__LEFT:
				return getLeft();
			case ShmlPackage.INTERVAL__RIGHT:
				return getRight();
			case ShmlPackage.INTERVAL__SUBINTERVAL:
