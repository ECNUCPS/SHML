 ...
 * </p>
 * <ul>
 *   <li>{@link ecnu.models.xshml.xshml.shml.impl.EvaluateGuardImpl#getVcondition <em>Vcondition</em>}</li>
 *   <li>{@link ecnu.models.xshml.xshml.shml.impl.EvaluateGuardImpl#getOnvariable <em>Onvariable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvaluateGuardImpl extends GuardImpl implements EvaluateGuard {
	...
	protected EClass eStaticClass() {
		return ShmlPackage.Literals.EVALUATE_GUARD;
	}
	...
	public void setVcondition(String newVcondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShmlPackage.EVALUATE_GUARD__VCONDITION, oldVcondition, vcondition));
	}
	...
	public Variable getOnvariable() {
		if (onvariable != null && onvariable.eIsProxy()) {
			...
			if (onvariable != oldOnvariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ShmlPackage.EVALUATE_GUARD__ONVARIABLE, oldOnvariable, onvariable));
			}
		}
		return onvariable;
	}
	...
	public void setOnvariable(Variable newOnvariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShmlPackage.EVALUATE_GUARD__ONVARIABLE, oldOnvariable, onvariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ShmlPackage.EVALUATE_GUARD__VCONDITION:
				return getVcondition();
			case ShmlPackage.EVALUATE_GUARD__ONVARIABLE:
