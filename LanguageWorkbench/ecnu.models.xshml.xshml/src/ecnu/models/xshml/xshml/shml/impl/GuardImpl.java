 ...
 * </p>
 * <ul>
 *   <li>{@link ecnu.models.xshml.xshml.shml.impl.GuardImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GuardImpl extends EObjectImpl implements Guard {
	...
	protected EClass eStaticClass() {
		return ShmlPackage.Literals.GUARD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShmlPackage.GUARD__NAME, oldName, name));
	}
