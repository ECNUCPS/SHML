...
public class EvaluateGuardAspect extends GuardAspect {
  ...
  public static boolean holdseg(final EvaluateGuard _self) {
	final ecnu.models.xshml.xshml.aspects.EvaluateGuardAspectEvaluateGuardAspectProperties _self_ = ecnu.models.xshml.xshml.aspects.EvaluateGuardAspectEvaluateGuardAspectContext
			.getSelf(_self);
	Object result = null;
	...
	if (manager != null) {
		manager.executeStep(_self, command, "EvaluateGuard", "holdseg");
	} else {
