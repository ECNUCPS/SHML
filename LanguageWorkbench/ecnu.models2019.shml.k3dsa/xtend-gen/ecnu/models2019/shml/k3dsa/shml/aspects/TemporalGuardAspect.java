...
public class TemporalGuardAspect extends GuardAspect {
  ...
  public static boolean holdstg(final TemporalGuard _self) {
    final ecnu.models2019.shml.k3dsa.shml.aspects.TemporalGuardAspectTemporalGuardAspectProperties _self_ = ecnu.models2019.shml.k3dsa.shml.aspects.TemporalGuardAspectTemporalGuardAspectContext.getSelf(_self);
    Object result = null;
    ...
    if (stepManager != null) {
    	stepManager.executeStep(_self,command,"TemporalGuard","holdstg");
    } else {
