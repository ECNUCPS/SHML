...
/**
 * This is the item provider adapter for a {@link shml.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ShmlPackage.Literals.EVENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSendPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_send_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_send_feature", "_UI_Event_type"),
				 ShmlPackage.Literals.EVENT__SEND,
				 true,
				 false,
				 false,
	...
	protected void addReceivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_receive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_receive_feature", "_UI_Event_type"),
				 ShmlPackage.Literals.EVENT__RECEIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addActivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_active_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_active_feature", "_UI_Event_type"),
				 ShmlPackage.Literals.EVENT__ACTIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
