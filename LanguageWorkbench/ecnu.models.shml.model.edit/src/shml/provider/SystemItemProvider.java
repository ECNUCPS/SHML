...
/**
 * This is the item provider adapter for a {@link shml.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ShmlPackage.Literals.SYSTEM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShmlPackage.Literals.SYSTEM__TSHSS);
			childrenFeatures.add(ShmlPackage.Literals.SYSTEM__GLOBALVARIABLES);
			childrenFeatures.add(ShmlPackage.Literals.SYSTEM__GLOBALCLOCKS);
			childrenFeatures.add(ShmlPackage.Literals.SYSTEM__GLOBALEVENTS);
		}
	...
	public String getText(Object object) {
		String label = ((shml.System)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(shml.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ShmlPackage.Literals.SYSTEM__TSHSS,
				 ShmlFactory.eINSTANCE.createTSHS()));

		newChildDescriptors.add
			(createChildParameter
				(ShmlPackage.Literals.SYSTEM__GLOBALVARIABLES,
				 ShmlFactory.eINSTANCE.createVariable()));

		newChildDescriptors.add
			(createChildParameter
				(ShmlPackage.Literals.SYSTEM__GLOBALCLOCKS,
				 ShmlFactory.eINSTANCE.createClock()));

		newChildDescriptors.add
			(createChildParameter
				(ShmlPackage.Literals.SYSTEM__GLOBALEVENTS,
