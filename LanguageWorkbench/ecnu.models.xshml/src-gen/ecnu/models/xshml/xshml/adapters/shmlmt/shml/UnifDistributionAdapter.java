...
public class UnifDistributionAdapter extends EObjectAdapter<UnifDistribution> implements shml.UnifDistribution {
  ...
  public EClass eClass() {
    return shml.ShmlPackage.eINSTANCE.getUnifDistribution();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case shml.ShmlPackage.UNIF_DISTRIBUTION__A:
    		return new java.lang.Float(getA());
    	case shml.ShmlPackage.UNIF_DISTRIBUTION__B:
