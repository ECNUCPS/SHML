...
public class GuardAdapter extends EObjectAdapter<Guard> implements shml.Guard {
  ...
  public EClass eClass() {
    return shml.ShmlPackage.eINSTANCE.getGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case shml.ShmlPackage.GUARD__NAME:
    		return getName();
    }
