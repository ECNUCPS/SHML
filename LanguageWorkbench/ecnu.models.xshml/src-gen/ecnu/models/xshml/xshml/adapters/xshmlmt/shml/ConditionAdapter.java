...
public class ConditionAdapter extends EObjectAdapter<Condition> implements ecnu.models.xshml.xshmlmt.shml.Condition {
  ...
  public EClass eClass() {
    return ecnu.models.xshml.xshmlmt.shml.ShmlPackage.eINSTANCE.getCondition();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case ecnu.models.xshml.xshmlmt.shml.ShmlPackage.CONDITION__NAME:
    		return getName();
    }
