...
public class GuardAdapter extends EObjectAdapter<Guard> implements ecnu.models.xshml.xshmlmt.shml.Guard {
  ...
  public EClass eClass() {
    return ecnu.models.xshml.xshmlmt.shml.ShmlPackage.eINSTANCE.getGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case ecnu.models.xshml.xshmlmt.shml.ShmlPackage.GUARD__NAME:
    		return getName();
    }
