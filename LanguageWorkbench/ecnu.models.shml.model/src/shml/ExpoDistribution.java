 ...
 * </p>
 * <ul>
 *   <li>{@link shml.ExpoDistribution#getLambda <em>Lambda</em>}</li>
 * </ul>
 *
 * @see shml.ShmlPackage#getExpoDistribution()
 * @model
 * @generated
 */
public interface ExpoDistribution extends EObject {
	 ...
	 * @see #setLambda(float)
	 * @see shml.ShmlPackage#getExpoDistribution_Lambda()
	 * @model
	 * @generated
	 */
	float getLambda();
	...
	/**
	 * Sets the value of the '{@link shml.ExpoDistribution#getLambda <em>Lambda</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
